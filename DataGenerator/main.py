...
"""TODO: MAKE SURE EACH ROW OF COMBINED_generated.csv includes all block of generated "image" """
...
def main(sample_type: str, results_path: str, save_path: str) -> None:
    ...
    corr_pts = data_generator.generate_n_points(80)
    ...
    Utils.write_to_csv(sample_type, save_path, data=pts)
    Utils.combine_generated_cvs(save_path)
